...
<head>
    ...
    <title>Fiesta de la Vaquilla de Fresnedillas de la Oliva</title>
    <style>
        .btn-light {
...
<body>
    ...
    <div class="btn-container">
        ...
        <button class="btn btn-light" onclick="showSection('reservas')">Reservas</button>
    </div>
    ...
    $conn->close();
    ?>
    <div id="reservas" class="content-container" style="display:none;">
        <div class='table-responsive'>
            <table class='table table-bordered'>
                <thead class='thead-dark'>
                    <tr>
